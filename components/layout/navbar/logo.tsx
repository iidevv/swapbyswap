...
const Logo = () => {
    return (
        <Link className="flex items-center" href='/'>
            <svg className='w-12 h-12 md:mr-4' width="182" height="180" viewBox="0 0 182 180" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className='text-lg hidden md:block'>SwapBySwap</span>
        </Link>
    )
}
